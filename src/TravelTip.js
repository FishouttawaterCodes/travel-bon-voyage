const locations = [
 {
  title: "The Ibeno Beach, Ibeno, Akwa Ibom State",
 ...
 {
  title: "Obudu Mountain Resort, Obudu, Cross River State",
 ...
 {
  title: "Ngwo Pine Forest, Awhum, Enugu State",
 ...
 {
  title: "Arochukwu Long Juju Slave Route, Arochukwu, Abia State",
  description: "The sacred altar, a six foot gully that takes people to the temple and the waterfall in Arochukwu Long Juju Slave route, beg tourists to explore the shrine of Ibn Ukpabi and the cult momument of Kamula."
 },
 {
  title: "The Giant Footprint of Ukhuse Oke, Owan, Edo State",
 ...
 {
  title: "Port Harcourt Tourist Beach, Port Harcourt, Rivers State",
 ...
 {
  title: "Gashaki-Gumpti National Park, Gashaki-Gumpti, Taraba State",
 ...
 {
  title: "The Tinapa Free Zone & Resort, Calabar, Cross River State", 
 ...
 {
  title: "The Emotan Statue",
  description: "Located opposite the Oba market in Benin City- Emotan Statue stands majestically, clad in her traditional wrapper and a headgear that is associated with royalty in the Benin Kingdom."
 },
 {
  title: "Coconut Beach, Badagry, Lagos State",
  description: "No place tells the story of tourism fused with history like Badagry. It has breathtaking and beautiful ocean views, a perfect place for relaxation. 20 miles before you get to the Republic of Benin lies Coconut beach, and it is surrounded by a lot of coconut trees."
 },
 {
  title: "Millennium Park",
  description: "The Millennium Park is the largest public park in the capital city of Abuja. It is situated in the Maitama district. Her Majesty Queen Elizabeth II of the United Kingdom was the one who inaugurated the park that has become kids’ paradise and a relaxation haven."
 },
 {
  title: "New Afrika Shrine",
  description: "When you feel like getting lost in music from the legendary Fela’s family,the New Afrika Shrine is where you should visit. This is the replacement of the original Shrine that was burnt down. A cover charge of N500 is collected. It is located in Adeleye Street, Ikeja."
 }, 
 {
